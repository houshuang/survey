defmodule Survey.ReflectionController do
  ...
  def index_c(conn, params) do
    params = Map.put(params, "id", 3)
    index(conn, params)
  end
  ...
  def index_e(conn, params) do
    params = Map.put(params, "id", 5)
    index(conn, params)
  end

  def index_f(conn, params) do
    params = Map.put(params, "id", 6)
    index(conn, params)
  end
